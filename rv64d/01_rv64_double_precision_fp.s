...
_start:
    ...
    # FCVT.L.D - Convert double to signed 64-bit integer
    # "FCVT.L.D converts a double-precision floating-point number in
    # floating-point register rs1 to a signed 32-bit or 64-bit integer"
    ...
    # FCVT.LU.D - Convert double to unsigned 64-bit integer
    ...
    # FCVT.D.LU - Convert unsigned 64-bit integer to double
    ...
    # "FMV.X.D and FMV.D.X instructions are provided to move bit
    ...
    # FMV.X.D - Move double-precision bits to integer register (RV64-only)
    ...
    # FMV.D.X - Move integer bits to double-precision register (RV64-only)
    ...
    # Test 32-bit conversions with sign extension
